...
export default function Shop() {
  return (
    <div>
      ...
      <div className="breadcrumb-section pt-40 pb-40">
        <div className="container-1700">
          <p className="breadcrumb-text mb-0">
            ...
            <span className="text-main-color">Shop</span>
          </p>
        </div>
      </div>
      ...
      {/*shop section start*/}
      <section className="shop-section bg-white ptb-80">
            ...
            <div className="col-xl-3 order-2 order-xl-1">
              <div className="shop-sidebar pe-xl-5 mt-5 mt-xl-0">
                <div className="sidebar-widget search-widget">
                  <form>
                    <input
                      ...
                      className="theme-input fw-light"
                    />
                  </form>
                </div>
                <div className="sidebar-widget categories-widget mt-60">
                  <h4 className="widget-title position-relative fw-normal mb-5">
                    Categories
                  </h4>
                  <ul className="sidebar-check-fields">
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Anklets</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Bracelets</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Pendants</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Earrings</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Gift Card</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Neaklaces</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Personalized</span>
                      </label>
                    </li>
                    <li>
                      <label>
                        <input type="checkbox" /> <span>Rings</span>
                      </label>
                    </li>
                  </ul>
                </div>
                ...
                <div className="sidebar-widget products-widget mt-60">
                  <h4 className="widget-title position-relative mb-5">
                    Latest products
                  </h4>
                  <ul className="sidebar-products">
                    <li className="d-flex align-items-center gap-4">
                      ...
                      <div>
                        <a href="product-details.html">
                          <h6 className="mb-3">Ambert Xoss Chair</h6>
                        </a>
                        <span className="price primary-text-color">
                          $165.00
                        </span>
                      </div>
                    </li>
                  ...
                  <div className="row g-4">
                        ...
                        <div className="product-content">
                          ...
                          <a href="product-details.html">
                            <h6 className="fw-semibold mt-3">
                              White Comfort Chairs
                            </h6>
                          </a>
                          <p className="fs-sm mb-4">
                            Nam accumsan urna leo fermentum egestas, erat id
                            vehicula at.
                          </p>
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="vr5-product-card">
                        <div className="feature-image position-relative h-300">
                          <img
                            src="assets/images/products/chair-md.png"
                            alt="not found"
                            className="img-fluid"
                          />
                          <div className="action-box">
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="vr5-product-card">
                        <div className="feature-image position-relative h-300">
                          <img
                            src="assets/images/products/chair-md-3.png"
                            alt="not found"
                            className="img-fluid"
                          />
                          <div className="action-box">
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="vr5-product-card">
                        <div className="feature-image position-relative h-300">
                          <img
                            src="assets/images/products/chair-md-4.png"
                            alt="not found"
                            className="img-fluid"
                          />
                          <div className="action-box">
